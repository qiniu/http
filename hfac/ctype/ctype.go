...
// Is tests a rune is typeMask or not.
...
// IsType tests a string is typeMask or not.
...
// IsTypeEx tests a string is (typeFirst, typeNext) or not.
...
// IsCSymbol tests a string is a c symbol or not.
func IsCSymbol(str string) bool {

	return IsTypeEx(CSYMBOL_FIRST_CHAR, CSYMBOL_NEXT_CHAR, str)
}

// IsXMLSymbol tests a string is an xml symbol or not.
